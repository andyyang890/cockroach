...
var versionTable = [numKeys]roachpb.Version{
	...
	V26_2_ChangefeedsStopWritingSpanLevelCheckpoint: {Major: 26, Minor: 1, Internal: 10},

	V26_2_ChangefeedsStopUsingSpanLevelCheckpoint: {Major: 26, Minor: 1, Internal: 12},
